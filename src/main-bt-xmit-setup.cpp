...
#define DPIN_BLUESRL_RX 8  // serial in  - talk to Bluetooth module (KCX_BT_EMITTER) - connect to YELLOW wire
#define DPIN_BLUESRL_TX 9  // serial out  - talk to Bluetooth module (KCX_BT_EMITTER) - connect to GREEN wire
